...
API_ID = int(environ.get('API_ID', '17665365')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'fdec634bb01a88d8289266df3c1bdaf5')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "7822516448:AAFLUkbxHCXvxiTrbU-Ws270t2W8wHDEoeA")    # Bot token from @BotFather
...
PICS_URL = (environ.get('PICS', 'https://files.catbox.moe/qz24wt.jpg')).split() #random anime girl img each time from aniwallpaper (Experimental)
PICS = (environ.get('PICS', 'https://files.catbox.moe/qz24wt.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1471883657').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002815641665').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002792865176'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002792865176'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002792865176'))  # Premium logs channel id
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002462700603")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002462700603")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://duniamoney3_db_user:tyson@tyson.saygjy0.mongodb.net/?appName=tyson")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "tyson") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'tyson_files') # Collection name (default: dreamcinezone_files)
...
SHORTENER_API = environ.get("SHORTENER_API", "9a90debd682f67dba44a86e5006768f14b8bc6b4") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "arolinks.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "9a90debd682f67dba44a86e5006768f14b8bc6b4")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "arolinks.com") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "9a90debd682f67dba44a86e5006768f14b8bc6b4")
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+yLIKZ9AmeRphNzg1') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/TysonSanju2000') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/Tyson_Movie_Files') # Update channel link for the bot
